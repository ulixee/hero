...
test('it should find correct browser meta', async () => {
    const browserMeta = index_1.default.selectBrowserMeta(`Mozilla/5.0 (Macintosh; Intel Mac OS X 12_4_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${index_1.defaultBrowserEngine.version.major}.0.4324.182 Safari/537.36`);

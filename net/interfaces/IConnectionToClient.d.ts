...
export default interface IConnectionToClient<IClientApiSpec extends IApiHandlers = IApiHandlers, IEventSpec = any> extends ITypedEventEmitter<IConnectionToClientEvents> {
...
export interface IConnectionToClientEvents<IClientApiSpec extends IApiHandlers = IApiHandlers, TKeys extends keyof IClientApiSpec & string = keyof IClientApiSpec & string, TEventSpec = unknown> {
    'send-error': Error;
    ...
    event: {
        event: ICoreEventPayload<TEventSpec>;
    };
}

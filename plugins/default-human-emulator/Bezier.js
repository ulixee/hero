...
const curveLength_1 = require("./curveLength");
...
class Bezier {
    ...
    length() {
        return (0, curveLength_1.default)(t => Bezier.compute(t, this.derivativePoints[0]));
    }
    getLookupTable(points = 100) {

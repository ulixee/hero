import { IInteractionStep, InteractionCommand } from '@unblocked/emulator-spec/interact/IInteractions';
import Log from '@ulixee/commons/lib/Logger';
import { IBoundLog } from '@ulixee/commons/interfaces/ILog';
import HumanEmulator from '../index';
import * as rectUtils from '@unblocked/secret-agent/lib/rectUtils';
import IInteractionsHelper from '@unblocked/emulator-spec/interact/IInteractionsHelper';

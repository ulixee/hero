...
import { IViewportSize } from '@ulixee/hero-interfaces/IInteractionsHelper';
...
export function isRectInViewport(
  ...
  return {
    width: isRectPointInBoundary(rect.x, rect.width, viewport.width, multiplier),
    height: isRectPointInBoundary(rect.y, rect.height, viewport.height, multiplier),
  };
}

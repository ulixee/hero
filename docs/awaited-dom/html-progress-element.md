# [AwaitedDOM](../basic-client/awaited-dom) <span>/</span> HTMLProgressElement

<div class='overview'>The <strong><code>HTMLProgressElement</code></strong> interface provides special properties and methods (beyond the regular <code>HTMLElement</code> interface it also has available to it by inheritance) for manipulating the layout and presentation of <code>&lt;progress&gt;</code> elements.</div>

## Properties

### elem.labels <div class="specs"><i>W3C</i></div> {#labels}

Returns <code>NodeList</code> containing the list of <code>&lt;label&gt;</code> elements that are labels for this element.
...
### elem.position <div class="specs"><i>W3C</i></div> {#position}

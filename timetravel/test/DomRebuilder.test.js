...
const DomRebuilder_1 = require("../lib/DomRebuilder");
describe('DomRebuilder tests', () => {
    const domRebuilder = new DomRebuilder_1.default(new Set([1]));
    let eventIndex = 1;
    test('it should be rebuild a basic dom structure', () => {
        ...
        domRebuilder.apply({ timestamp: dom[0].timestamp, commandId: 1, changeEvents: dom });
        ...
        const dom = [
            {
                ...base,
                eventIndex: (eventIndex += 1),
                action: IDomChangeEvent_1.DomActionType.removed,
                nodeId: 6,
                nodeType: 1,
                parentNodeId: 5,
            },
...
//# sourceMappingURL=DomRebuilder.test.js.map
# [AwaitedDOM](/docs/basic-interfaces/awaited-dom) <span>/</span> SVGStringList
...
A mirror of the value in <code>numberOfItems</code>, for consistency with other interfaces. <span class="icon-only-inline" title="This API has not been standardized."><i class="icon-warning-sign"> </i>
</span>

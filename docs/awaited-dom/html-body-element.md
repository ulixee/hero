# [AwaitedDOM](../basic-client/awaited-dom) <span>/</span> HTMLBodyElement

<div class='overview'>The <strong><code>HTMLBodyElement</code></strong> interface provides special properties (beyond those inherited from the regular <code>HTMLElement</code> interface) for manipulating <code>&lt;body&gt;</code> elements.</div>

## Properties

### elem.aLink <div class="specs"><i>W3C</i></div> {#aLink}

Is a `string` that represents the color of active hyperlinks.

#### **Type**: `Promise<string>`

### elem.background <div class="specs"><i>W3C</i></div> {#background}
...
### elem.link <div class="specs"><i>W3C</i></div> {#link}
...
### elem.vLink <div class="specs"><i>W3C</i></div> {#vLink}

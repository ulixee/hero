import IJsPath, { IPathStep, IMethod, INodeId, IPropertyName } from './interfaces/IJsPath';
...
export { IJsPath, IPathStep, IElementRect, INodePointer, INodeVisibility, IJsPathError, IMethod, INodeId, IPropertyName, };

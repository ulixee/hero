...
export default interface INetworkHooks {
    ...
    shouldInterceptRequest?(url: URL, resourceTypeIfKnown?: IResourceType): Promise<boolean> | boolean;
    handleInterceptedRequest?(url: URL, type: IResourceType, request: http.IncomingMessage | http2.Http2ServerRequest, response: http.ServerResponse | http2.Http2ServerResponse): Promise<boolean> | boolean;

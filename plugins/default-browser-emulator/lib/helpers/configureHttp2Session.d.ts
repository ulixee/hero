...
export default function configureHttp2Session(emulationProfile: IEmulationProfile, data: IBrowserData, resource: IHttpResourceLoadDetails, settings: IHttp2ConnectSettings): void;

...
class TypeSerializer {
    ...
    static reviver(stackMarker, key, entry) {
        ...
        if (type === Types.Int32Array)
            return Int32Array.from(value.split(','));
        if (type === Types.Uint32Array)
            return Uint32Array.from(value.split(','));
        if (type === Types.Float32Array)
            return Float32Array.from(value.split(','));
        if (type === Types.Float64Array)
            return Float64Array.from(value.split(','));

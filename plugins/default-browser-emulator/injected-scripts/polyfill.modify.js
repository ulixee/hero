...
exports.main = main;
function main({ args, utils: { getObjectAtPath, toOriginalFn, overriddenFns, nativeToStringFunctionString, getParentAndProperty, getDescriptorInHierarchy, replaceGetter, replaceFunction, ObjectCached, ReflectCached, invocationReturnOrThrow, OtherInvocationsTracker, PathToInstanceTracker }, }) {
    for (const itemToModify of args.itemsToModify) {
        try {
            ...
            if (!parts)
                throw new Error('failed to find parent and property');

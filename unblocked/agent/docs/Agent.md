...
Each Agent implements the full Unblocked [Plugin Specification](https://github.com/unblocked-web/unblocked/main/tree/specification/plugin) allowing developer control along the full spectrum of web scraping sessions.
...
- options `IAgentCreateOptions`:
  ...
  - plugins `IUnblockedPluginClass[]` - A list of [Plugins](https://github.com/unblocked-web/unblocked/main/tree/specification/plugin/IUnblockedPlugin.ts) classes (`IUnblockedPluginClass`). These plugins will be installed into all hooks for the agent.
  ...
  - options `IEmulationOptions` An optional configuration accepting all [EmulationProfile](https://github.com/unblocked-web/unblocked/main/tree/specification#emulation-profile) settings.

# [AwaitedDOM](/docs/hero/basic-client/awaited-dom) <span>/</span> HTMLMediaElement
...
#### **Type**: [`AudioTrackList`](/docs/hero/awaited-dom/audio-track-list)
...
#### **Type**: [`TimeRanges`](/docs/hero/awaited-dom/time-ranges)
...
#### **Type**: [`MediaError`](/docs/hero/awaited-dom/media-error)
...
#### **Type**: [`TextTrackList`](/docs/hero/awaited-dom/text-track-list)
...
#### **Type**: [`VideoTrackList`](/docs/hero/awaited-dom/video-track-list)

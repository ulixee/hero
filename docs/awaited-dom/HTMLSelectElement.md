# [AwaitedDOM](/docs/hero/basic-client/awaited-dom) <span>/</span> HTMLSelectElement
...
#### **Type**: [`HTMLFormElement`](/docs/hero/awaited-dom/html-form-element)
...
#### **Type**: [`HTMLOptionsCollection`](/docs/hero/awaited-dom/html-options-collection)
...
#### **Returns**: [`HTMLOptionElement`](/docs/hero/awaited-dom/html-option-element)

# [AwaitedDOM](/docs/hero/basic-client/awaited-dom) <span>/</span> HTMLTableElement
...
#### **Type**: [`HTMLTableCaptionElement`](/docs/hero/awaited-dom/html-table-caption-element)
...
#### **Type**: [`HTMLTableSectionElement`](/docs/hero/awaited-dom/html-table-section-element)

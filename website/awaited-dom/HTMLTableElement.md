...
### .createCaption*(requestInput, requestInit)* <div class="specs"><i>W3C</i></div> {#createCaption}
...
### .createTBody*(requestInput, requestInit)* <div class="specs"><i>W3C</i></div> {#createTBody}
...
### .createTFoot*(requestInput, requestInit)* <div class="specs"><i>W3C</i></div> {#createTFoot}
...
### .createTHead*(requestInput, requestInit)* <div class="specs"><i>W3C</i></div> {#createTHead}
...
### .deleteCaption*(requestInput, requestInit)* <div class="specs"><i>W3C</i></div> {#deleteCaption}

Removes the first <a href="/en-US/docs/Web/HTML/Element/caption" title="The HTML Table Caption element (<caption>) specifies the caption (or title) of a table, and if used is always the first child of a <table>."><code>&lt;caption&gt;</code></a> that is a child of the element.
...
### .deleteRow*(requestInput, requestInit)* <div class="specs"><i>W3C</i></div> {#deleteRow}
...
### .deleteTFoot*(requestInput, requestInit)* <div class="specs"><i>W3C</i></div> {#deleteTFoot}

Removes the first <a href="/en-US/docs/Web/HTML/Element/tfoot" title="The HTML <tfoot> element defines a set of rows summarizing the columns of the table."><code>&lt;tfoot&gt;</code></a> that is a child of the element.
...
### .deleteTHead*(requestInput, requestInit)* <div class="specs"><i>W3C</i></div> {#deleteTHead}

Removes the first <a href="/en-US/docs/Web/HTML/Element/thead" title="The HTML <thead> element defines a set of rows defining the head of the columns of the table."><code>&lt;thead&gt;</code></a> that is a child of the element.
...
### .insertRow*(requestInput, requestInit)* <div class="specs"><i>W3C</i></div> {#insertRow}

# [AwaitedDOM](/docs/basic-client/awaited-dom) <span>/</span> HTMLTableElement
...
#### **Type**: [`HTMLTableCaptionElement`](/docs/awaited-dom/html-table-caption-element)
...
#### **Type**: [`HTMLTableSectionElement`](/docs/awaited-dom/html-table-section-element)

...
export function findClosestVersionMatch(versionToMatch: string, versions: string[]): string {
...
export function getClosestNumberMatch(numToMatch: number, nums: number[]): number {

...
type DomNodeOrPromiseValue<T> = T extends PromiseLike<infer R> ? R : T extends IAwaitedNode ? T : never;
...
export type IDomStateAssertions = <T>(statePromise: T, assertionFnOrValue?: ((state: DomNodeOrPromiseValue<T>) => boolean) | DomNodeOrPromiseValue<T>) => void;
export {};

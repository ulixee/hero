# [AwaitedDOM](../basic-client/awaited-dom) <span>/</span> HTMLDocument
...
#### **Type**: [`DocumentType`](./document-type.md)
...
#### **Type**: [`HTMLHeadElement`](./html-head-element.md)
...
#### **Type**: [`DOMImplementation`](./dom-implementation.md)
...
#### **Returns**: [`CaretPosition`](./caret-position.md)

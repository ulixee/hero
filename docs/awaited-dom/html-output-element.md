# [AwaitedDOM](../basic-client/awaited-dom) <span>/</span> HTMLOutputElement

<div class='overview'>The <strong><code>HTMLOutputElement</code></strong> interface provides properties and methods (beyond those inherited from <code>HTMLElement</code>) for manipulating the layout and presentation of <code>&lt;output&gt;</code> elements.</div>

...
# [2.0.0-alpha.12](https://github.com/ulixee/agent/compare/v2.0.0-alpha.11...v2.0.0-alpha.12) (2022-10-31)


### Bug Fixes

* **mitm:** replace paths in env actual vars ([c23df26](https://github.com/ulixee/agent/commit/c23df26f699b6fc81bd95815723aae483d5556c3))
* **mitm:** try to handle socket timeouts ([27adbb0](https://github.com/ulixee/agent/commit/27adbb0f27e7b6a2efab156c1221201c84d3d85e))


### Features

* **core:** convert to use .env.defaults files ([f2f0832](https://github.com/ulixee/agent/commit/f2f083289c76bd7f544cb7048402761d5288febc))





# [2.0.0-alpha.11](https://github.com/ulixee/agent/compare/v2.0.0-alpha.10...v2.0.0-alpha.11) (2022-10-03)


### Bug Fixes

* default chrome not working in tests ([f100624](https://github.com/ulixee/agent/commit/f100624f272361e330c2e436e1ea77130ba35d07))
* github automation ([d91847b](https://github.com/ulixee/agent/commit/d91847bbb9394a148ac4d93a638d789c12cd0807))
* lint and test fix attempt 2 ([30eebb7](https://github.com/ulixee/agent/commit/30eebb778332fd9b890caf17d3e9c8523fa4f198))
* **mitm:** tls/tcp hooks not called ([cf2e659](https://github.com/ulixee/agent/commit/cf2e6597400748456487bff15210c67b7498d72d))
* parse alps settings in TLS connection ([de9f463](https://github.com/ulixee/agent/commit/de9f463d78a8e563f9cae7f5452c19097c77d558))





# [2.0.0-alpha.10](https://github.com/ulixee/agent/compare/v2.0.0-alpha.9...v2.0.0-alpha.10) (2022-08-31)


### Bug Fixes

* **core:** don’t log no-resource if mitm disabled ([3b168fe](https://github.com/ulixee/agent/commit/3b168febb455dc8e6ea5584f5a12b5fb75bc1144))
* **core:** force x86 chrome on m1 ([630b36d](https://github.com/ulixee/agent/commit/630b36dc8ddbc2f508b458030c54bc9330d785ec))





# [2.0.0-alpha.9](https://github.com/ulixee/agent/compare/v2.0.0-alpha.7...v2.0.0-alpha.9) (2022-08-16)


### Bug Fixes

* **core:** fileprompt not working after nav ([7e7ad40](https://github.com/ulixee/agent/commit/7e7ad401d03e68c9e54f15bf58511be9a65f7eae))
* **mitm:** allow websockets when h2 server ([cca0419](https://github.com/ulixee/agent/commit/cca0419f65539129d5f5a44e76f2ce4ecdec6b24))
* **mitm:** intercepted resources blowing up ([4d42863](https://github.com/ulixee/agent/commit/4d428633580bcfe1822383ec871cea908e330e91))


### Features

* **core:** improve error when browser can’t open ([a4089df](https://github.com/ulixee/agent/commit/a4089df616679075cafbc1285c71d5388cf63ed9))
* **mitm:** cleanup sockets ([abcfc61](https://github.com/ulixee/agent/commit/abcfc618e66ea5dbc42bf7144216482d11666d10))
* **mitm:** keep error handlers ([ce45b78](https://github.com/ulixee/agent/commit/ce45b78e63a977ef1e249c19b2f0efcbe205ed39))





# [2.0.0-alpha.8](https://github.com/ulixee/agent/compare/v2.0.0-alpha.7...v2.0.0-alpha.8) (2022-08-16)
...
# [2.0.0-alpha.7](https://github.com/ulixee/agent/compare/v2.0.0-alpha.6...v2.0.0-alpha.7) (2022-07-26)


### Bug Fixes

* **mitm:** conn segfault in case of dns error ([d02f2af](https://github.com/ulixee/agent/commit/d02f2af425966a221e2765de491b2d967f3e41df))
* yarn.lock ([2cebd69](https://github.com/ulixee/agent/commit/2cebd6985d86e830649333f975f68eb1440c9b9f))





# [2.0.0-alpha.6](https://github.com/ulixee/agent/compare/v2.0.0-alpha.5...v2.0.0-alpha.6) (2022-07-13)


### Bug Fixes

* **core:** handle evaluate with no frame context ([c65e066](https://github.com/ulixee/agent/commit/c65e0664ec1469a790431cbb3c63ea5e1c05e431))
* remove extraneous logging and nav ([91c641c](https://github.com/ulixee/agent/commit/91c641c756658fbd8355ea164213657235f43127))





# [2.0.0-alpha.5](https://github.com/ulixee/agent/compare/v2.0.0-alpha.4...v2.0.0-alpha.5) (2022-06-28)


### Bug Fixes

* **core:** allow navigation to about:blank ([d3c4c1b](https://github.com/ulixee/agent/commit/d3c4c1b36b9870bbf3b5ff28ab5c72929397985b))
* **core:** not properly attaching to devtools ([ca655e7](https://github.com/ulixee/agent/commit/ca655e7ba7c204372d2b2544f8a3b8dd98ac5b29))
* **core:** shadow dom clicks not working ([7283528](https://github.com/ulixee/agent/commit/7283528b305b772addb9f3e78dd7ef52faa7efa2))
* don’t reuse http2 socket ([74f5ff8](https://github.com/ulixee/agent/commit/74f5ff88b1f5879326fefc83a5c6d727eb5f35a5))
* test ([6c39728](https://github.com/ulixee/agent/commit/6c39728283d4a3b60f48ac367f520adcaa1c21f6))
* update lint ([70abdc7](https://github.com/ulixee/agent/commit/70abdc7ec18975f965ea638dfd0d91fae60257eb))


### Features

* **core:** add dom overrides fn ([b6d0243](https://github.com/ulixee/agent/commit/b6d0243b0d8eeaa5155c2a6942ad2e3f572c07d7))
...
# [2.0.0-alpha.3](https://github.com/ulixee/agent/compare/v2.0.0-alpha.2...v2.0.0-alpha.3) (2022-06-09)


### Bug Fixes

* cross domain cookies ([55b33c5](https://github.com/ulixee/agent/commit/55b33c5cf0d5cf998d22cabdf750d38a55f6183e))
* disableMitm setting broken ([2e7a9e0](https://github.com/ulixee/agent/commit/2e7a9e0fd9559d3fdd73b065905dea2a74d2501d))
* lint issue ([443dd3b](https://github.com/ulixee/agent/commit/443dd3b23d3748d414ec827b84d338dd55a5042c))
* **mitm-socket:** alps TLS extension ([aac86f3](https://github.com/ulixee/agent/commit/aac86f372cc55dbf28b89164b1c1559f2829c542))





# [2.0.0-alpha.2](https://github.com/ulixee/agent/compare/v2.0.0-alpha.1...v2.0.0-alpha.2) (2022-05-19)


### Bug Fixes

* build ([711467c](https://github.com/ulixee/agent/commit/711467c51fd020c292fc9f3373ba2d4719f6575e))
* socket await ([dba7b72](https://github.com/ulixee/agent/commit/dba7b72f73ada2f2cd270667e84e5dd42c57eca9))


### Features

* add option to keep resource bodies ([3db2900](https://github.com/ulixee/agent/commit/3db2900efd02eb56e95028129faf970643913bb1))
...
* **client:** reload should return a resource ([83b80b5](https://github.com/ulixee/agent/commit/83b80b5b3d70bc06344fb64d31fed1434ac98114)), closes [#393](https://github.com/ulixee/agent/issues/393)
...
* **plugins:** improve user agent selector ([cd708bb](https://github.com/ulixee/agent/commit/cd708bbc8e46705376f9cf3bd438a59c0063b6e7))
...
* **puppet:** don't use contexts we didn't initiate ([710acab](https://github.com/ulixee/agent/commit/710acabd1b4c0275d95048cb9f0053e2775f4d77))
* **puppet:** fix flakiness on frame stopped ([002a516](https://github.com/ulixee/agent/commit/002a51601123565b774f3589ddd9e35494516035))
* **puppet:** fix shutdown issues (port from hero) ([2b70752](https://github.com/ulixee/agent/commit/2b70752054edae95701243cc59afa48e113856fe))
...
* **human-emulator:** fix updated traget point ([98eabd1](https://github.com/ulixee/agent/commit/98eabd183660fd2cbbc44575f2703ae86e5e2950))
* **puppet:** fix stack trace for protocol error ([8a5b4bf](https://github.com/ulixee/agent/commit/8a5b4bf16b53268509b0ad93d3db74559f6de699))
...
* **plugins:** not calling initialization in time ([1ecebed](https://github.com/ulixee/agent/commit/1ecebed990f70fc61250b779b15b8dcbc1e4c2c7))
...
* **plugin:** export ClientPlugin/CorePlugin ([882674c](https://github.com/ulixee/agent/commit/882674c9397d878922ce9863429f5e156d3df9e4))
* **plugins:** iframe content window wrong ([7381189](https://github.com/ulixee/agent/commit/7381189f44cf28738e50dab40546b9b83141c31d))
...
* **docs:** tweak docs ([39632b5](https://github.com/ulixee/agent/commit/39632b5a51b97eb708fa8f26ac7d247725474926))
* **plugins:** remove codecs overrides for chrome ([17a16a5](https://github.com/ulixee/agent/commit/17a16a515de3dfa65d6624f5c3f5244a744755d1))
...
* **plugins:** fix versions not sorting correctly ([b9e7620](https://github.com/ulixee/agent/commit/b9e76205c9c615f2639ca39e0f1e589c8bf15adf))


### Features

* **replay:** use old scripts for path to start core ([c1f893d](https://github.com/ulixee/agent/commit/c1f893de9a871d3e94450a721ac7c05fcc17ceee))
...
* move back to pipeTransport ([e13f048](https://github.com/ulixee/agent/commit/e13f048b22776bf847bddb870f921d148f243b10))
...
* **puppet:** always shut down chrome ([b16ed81](https://github.com/ulixee/agent/commit/b16ed81715ef02630ab0f8f48f12c60b7a0f12ee))
* **puppet:** catch errors in indexedDb export ([a787b1d](https://github.com/ulixee/agent/commit/a787b1d94da81cb3ed768fb0b1587d96739a23e7))
...
* **client:** allow plugins in handlers ([5371d99](https://github.com/ulixee/agent/commit/5371d99dbb7968b55b895444203e7b204acfa19c))
...
* change userAgent example to remove asterisk ([f268ae8](https://github.com/ulixee/agent/commit/f268ae8ab65510a008e6b4112330c89b23e9ff8c))
* cherrypick bug fixes from hero ([a3e8fbf](https://github.com/ulixee/agent/commit/a3e8fbfa42570df605487f53b5b0cc784eaf6423))
* lerna hero reference wrong ([de13ab7](https://github.com/ulixee/agent/commit/de13ab7c33301ff69575a4d43ce75378f6bcb4f1))
* restructure issues ([186bc06](https://github.com/ulixee/agent/commit/186bc0661fcacf541fb1577510c37e03c4f8eb70))
...
* **plugins:** chrome 88 emulator data ([f537be2](https://github.com/ulixee/agent/commit/f537be23fa2d101f275d01671e3f0d12ac1374a6))
...
* fixed some unclear documentation related to plugins ([9868428](https://github.com/ulixee/agent/commit/98684285e5218808f506fad1cdf68c0e4662e017))
* useragent was not correctly parsing mac os 11 ([3a177ed](https://github.com/ulixee/agent/commit/3a177edb690f0f6373942720f3fdf304a2aad596))
* **core:** fix interact with elements in iframes ([c0c7a6e](https://github.com/ulixee/agent/commit/c0c7a6e0b93fddf418edf1298bb2d1419ebd65ed))
* **puppet:** clean data dir on close ([6c2b85f](https://github.com/ulixee/agent/commit/6c2b85f007656192a8c103c2aa6752a0de3ab091))
* **puppet:** retry on failure to delete chrome dir ([ccb07b3](https://github.com/ulixee/agent/commit/ccb07b3a9f77e51ce35fbd20dd6a5b8c7310eaf4))


### Features

* args can now be passed into ExecuteJsPlugin ([0ed06f0](https://github.com/ulixee/agent/commit/0ed06f0e98a3076c04e5a1aedd5e0dfc53ac6392))
* first stab at documenting plugins + simplified plugin architecture ([fcaa3cf](https://github.com/ulixee/agent/commit/fcaa3cfdca98b6f85128c196369d63ae40642df1))
* register Core plugins through agent.use ([eb08964](https://github.com/ulixee/agent/commit/eb0896454ed1e265459fc174a937f666c975844d))
...
* **interfaces:** remove looping reference ([83d6d88](https://github.com/ulixee/agent/commit/83d6d8807b515b036980490eace7d80550b27f53))
...
* **website:** fix contributors links ([e816b3b](https://github.com/ulixee/agent/commit/e816b3be3782b5382a07886c684e98964142247d))
...
* **core:** headed mode broken ([9d6ad5b](https://github.com/ulixee/agent/commit/9d6ad5b54fb2d7464c3cbae90653a04af16d5c1f))
* **docs:** wrong frame api ([66733e5](https://github.com/ulixee/agent/commit/66733e541d8315d95fb71fc3da9896c0626cec61))
* **plugins:** inconsistent dom env properties ([405e91b](https://github.com/ulixee/agent/commit/405e91bc07fd7225c6eebe8d46843242c8527c48))
...
* hid BrowserEmulator and HumanEmulator docs until I finish rewriting them ([de8a549](https://github.com/ulixee/agent/commit/de8a5499955914be64992274bc3a0c8df656d437))
* userAgent option wasn't being properly extracted ([18dbda6](https://github.com/ulixee/agent/commit/18dbda6b5834d9900ba7f51260ad8519f7b4c56d))
...
* **docs:** absolute urls to nested links ([480092b](https://github.com/ulixee/agent/commit/480092b03ce1b708fb8d9cff52090f1aea59087e))
* **docs:** frame link broken ([d428fd3](https://github.com/ulixee/agent/commit/d428fd38101c0d58f4f69aa98eb0efd2de5e92da))
...
* setup submodules before running github lint ([6ce69c8](https://github.com/ulixee/agent/commit/6ce69c822c7286f3a596dd0a706a11c5f21a3bab))
...
* **client:** add output to handlers ([1c143b4](https://github.com/ulixee/agent/commit/1c143b4e84145a4eb5e8df0e52c7d69c64efeb7a))
* **client:** allow awaiting xpath ([708dfd9](https://github.com/ulixee/agent/commit/708dfd9ad09fbead841c88bdc54582fd7fe10868)), closes [#239](https://github.com/ulixee/agent/issues/239)
...
* **docs:** add detached documentation ([18bbc64](https://github.com/ulixee/agent/commit/18bbc646ba1129e95e98cd45f953b15a5d7a36e0))
...
* **interfaces:** fix devtools command typing ([00af054](https://github.com/ulixee/agent/commit/00af054cc6c971c59b35c964bbe3ba568aadb151))
...
* **emulate:** fix removed iframe platform ([27d2e4f](https://github.com/ulixee/agent/commit/27d2e4f356e1201383ccd2f568cd6696c949b8ae))
...
* **puppet:** dont double-create isolated world ([0df01e2](https://github.com/ulixee/agent/commit/0df01e26184dca1f10aa0a43c8203b12e4eec8af))
...
* **puppet:** convert to websocket ([43af64e](https://github.com/ulixee/agent/commit/43af64e3ee6167bf8ff5c2f0c07977fc7a368ed1))
...
* **client:** adjust return error pattern to throw ([884e87d](https://github.com/ulixee/agent/commit/884e87db16a5706dc50416e3df0defa67f0606e2))
...
* **puppet:** record logs for failing tests ([3d7ee18](https://github.com/ulixee/agent/commit/3d7ee18101bf6c913438901d9191caf1116de35f))
...
* **ghost:** fix oom error ([7ec100f](https://github.com/ulixee/agent/commit/7ec100f2070223a9172855fa23cedfcc61537755))
...
* **puppet:** don’t emit timeouts ([1dd386f](https://github.com/ulixee/agent/commit/1dd386f7cde45a66c7976a63b1e162b5b93863f1))
...
* test timeout ([b7b6af2](https://github.com/ulixee/agent/commit/b7b6af2a28d349df8e7e9aed49ca3bfe67ad08e1))
...
* **docs:** reference Chrome vs Chromium ([94226b2](https://github.com/ulixee/agent/commit/94226b20aff716f150a8d1134052ddef7b188378))
...
* **replay:** don’t remove preserved tags ([fe023d5](https://github.com/ulixee/agent/commit/fe023d5707fb9b1c7e1bed987bbde4ba0dd6511d))
* failing test ([a6ae58d](https://github.com/ulixee/agent/commit/a6ae58dc02940fce6a9184d0d5adc1b2ee29bd45))
* failing test ([9064518](https://github.com/ulixee/agent/commit/906451802f31f362c7e82bf2b094a03bfcf74420))
* lerna config ([77a1810](https://github.com/ulixee/agent/commit/77a18100ba1e29576323b35e1e947bf83d96b5e5))
* removed unnecessary browserVersionDir in EngineFetcher ([9daa98a](https://github.com/ulixee/agent/commit/9daa98a42234b27898e2e2c2bada3815a5826ba6))
...
* **client:** waitForAllDispatchesSettled ([cf3e6b5](https://github.com/ulixee/agent/commit/cf3e6b540fd312e771f72ff27a08bf3ee9f6212a))
* **puppet:** switch to chrome ([d064e53](https://github.com/ulixee/agent/commit/d064e53ace2107ac95348cf721c3cc35afe07efc))
* **puppet:** unsupported linux install message ([fe6e634](https://github.com/ulixee/agent/commit/fe6e63472a813c6275433b8dfb00e094c49c8a6a))
* **puppet:** update docker to for new installs ([19351b5](https://github.com/ulixee/agent/commit/19351b556718161c885b5dfb12f7fa80af8daf46))
* **replay:** update for mac silicon + deps ([30ffec7](https://github.com/ulixee/agent/commit/30ffec74fc06485b56344f17374a082d2055c1f1))
* **website:** blog post about chrome + atom ([b6dc12b](https://github.com/ulixee/agent/commit/b6dc12b4eb008100d30c58699468b877ce1e86ff))
* **website:** blog post about chrome + atom ([5f0cafa](https://github.com/ulixee/agent/commit/5f0cafa633f50aa0757dc3627ec6b06c27fd8f99))
...
* os version should fallback to major if no minor exists ([374cf76](https://github.com/ulixee/agent/commit/374cf7601060350df985f2ff41bde56c6cd8b824))
...
* **emulate:** clean toString stack trace ([21582b3](https://github.com/ulixee/agent/commit/21582b31d891d19299c22ddf30e15a6c38bf242a))
* **logger:** don’t use colors if disalbed in node ([c3af5a0](https://github.com/ulixee/agent/commit/c3af5a07984865bfa6f5278fe442bea80f00166f))
...
* **puppet:** fix waiting for worker ready ([e511009](https://github.com/ulixee/agent/commit/e51100900dd52c6962639bab240f1cdac24f5d50))
...
* **docs:** fix port param in remote docs ([3b452d8](https://github.com/ulixee/agent/commit/3b452d871e3778c6ca6fb1d19ec0b44bdbec4da7))
...
* **blog:** fix some blog typos ([e85efb6](https://github.com/ulixee/agent/commit/e85efb686a99bd1f9395e107aa528703de7b9259))
...
* **client:** fix reviving stack traces in typeson ([7a0e38b](https://github.com/ulixee/agent/commit/7a0e38b6e8efd30a2d70c0c3c73d8fc121e316a9))
* **dist:** copy .mjs files properly to npm dist ([cc717e0](https://github.com/ulixee/agent/commit/cc717e02ef94233ad867393640fc740b26038a95))
* **docs:** document missing props ([58e6a68](https://github.com/ulixee/agent/commit/58e6a68d1d1755fe459e9a1cb1151ce959e8c143)), closes [#156](https://github.com/ulixee/agent/issues/156)
...
* ejs modules not being copied to dist ([606102e](https://github.com/ulixee/agent/commit/606102e1a671b9a3dbab16b4411af8499aed3820))
* fix some linting in DomExtractor + added it to eslint ignore ([952943f](https://github.com/ulixee/agent/commit/952943ff3f7d50c475dc0c9de78bcf4b206f526a))
* pulled latest DomExtractor from DA ([a599e05](https://github.com/ulixee/agent/commit/a599e058560732aa6a83f2994d4b3dc9628e2d6f))
...
* some tests were failing ([91217b2](https://github.com/ulixee/agent/commit/91217b2e7d79a0d8a1a9b9c2e388b5dab7af3372))
...
* **replay:** don’t hang if screen not available ([22edc84](https://github.com/ulixee/agent/commit/22edc8412216a50b98b7cf99f6a32e0bc4687e1d)), closes [#146](https://github.com/ulixee/agent/issues/146)
...
* **build:** ignore emulator json files for ts ([b64f208](https://github.com/ulixee/agent/commit/b64f2087003502383643056f6db9257b98b231c8))
* **client:** allow waiting on resources ([d3414a8](https://github.com/ulixee/agent/commit/d3414a8f82b3c31c012953bf739d493076f0a759))
* **client:** error handling for session connect ([82e58b8](https://github.com/ulixee/agent/commit/82e58b826908d7e14d21f58673b1eb0044b4b9a2))
* **core:** elements offscreen fail isVisible ([f0042fc](https://github.com/ulixee/agent/commit/f0042fc79bc8006c34c2eae408e193ad3eea7fb7))
...
* **mitm:** preflight requests not always sent ([45ebe22](https://github.com/ulixee/agent/commit/45ebe224cd60c9e518139ff40786b90ee640be52))
* **puppet:** assigning wrong id to network fetches ([c4b6746](https://github.com/ulixee/agent/commit/c4b674655ceff4a4642fe9aada355709dc243e22))
* **puppet:** fallback to requestid in fetch ([28ad324](https://github.com/ulixee/agent/commit/28ad3242d679c8fa1d67e2f278f559a61fdd46ff))
...
* added userAgentOptions() to @BrowserEmulatorClassDecorator ([0a2187c](https://github.com/ulixee/agent/commit/0a2187ca3937618aa59f87045e03c34d13ff7cf0))
...
* emulators only had partial data ([3dd86db](https://github.com/ulixee/agent/commit/3dd86db74cdc6e3e02afc7556e1ba41716c37293))
...
* **replay:** upgrade axios (dependabot) ([2f55df9](https://github.com/ulixee/agent/commit/2f55df902cd7d3cf5e542c57c7df01f869340cf8))
* added url in comments to show where darwinToMacOsVersionMap was pulled ([ed873b1](https://github.com/ulixee/agent/commit/ed873b11965ab7255e32202b1b9e84d754178d89))
...
* disabled eslint rule for a failing line ([749ae1e](https://github.com/ulixee/agent/commit/749ae1e65b86338ff9666b9e3e7dc9dadf114677))
* increase node memory limit for yarn lint on github ([9c8a914](https://github.com/ulixee/agent/commit/9c8a914d3b4b63aaa31812e014631770fbf95977))
* tweaked a few lint issues ([ad9f17d](https://github.com/ulixee/agent/commit/ad9f17da63bad824a7e2dba8d77c0ec0fe9ea9da))
* updated dom diffs to include all oses supported by browserstack ([686a2e2](https://github.com/ulixee/agent/commit/686a2e2c00dd4191db79824f29ac119a1e99715e))
...
* **client:** add sessionid/name to logs + errors ([7d88f35](https://github.com/ulixee/agent/commit/7d88f3555076647307dc1e9e6cea9b102033c756))
...
* **client:** export required enums and consts ([4cce3a7](https://github.com/ulixee/agent/commit/4cce3a769e41bba49ad8a8bc8c83de53711f091b))
...
* **replay:** allow running out of a dist dir ([e5bfe21](https://github.com/ulixee/agent/commit/e5bfe211e0388bd4b1be1da97356046b983b80ea))
* **replay:** convert api to use web sockets ([18c8008](https://github.com/ulixee/agent/commit/18c80087d22f3ee95ee2eb5853b422219da6ceb1))
* **replay:** move to lighter semver lib ([5c4d1dc](https://github.com/ulixee/agent/commit/5c4d1dcfaf4a79d6457857647203addbbda8eba5))
* **replay:** prefer local build to binary ([71589cf](https://github.com/ulixee/agent/commit/71589cfc0ae8f31911e72b9f3e1fd3bcc4254c35))
...
* emulators pull roundRobinPercent from config ([2590387](https://github.com/ulixee/agent/commit/2590387d4ca7f79e6916e3321b5d27e19c6a1341))
...
* pull in os-version maps from Slab to reduce chance of stale data ([201b3c9](https://github.com/ulixee/agent/commit/201b3c9d028b798ce4a88ec05fd9833c95d89a0b))
...
* updated emulator data to handle more runtime OSes ([f57f3b5](https://github.com/ulixee/agent/commit/f57f3b5f1b18bcdaf56bf7e9a4475bf2e0c0b1c6))
...
* **browser-emulators:** fix cross frame tostring ([27a69d9](https://github.com/ulixee/agent/commit/27a69d9703766d653c0e841e6d69458e643faba2))
...
* **puppet:** workers not tracking devtools calls ([b339758](https://github.com/ulixee/agent/commit/b339758c8bb5b2076f1337dee3d0deefaf3fb7ad))
...
* **replay:** replay crashes on win10 during load ([b6e517b](https://github.com/ulixee/agent/commit/b6e517bcd6a66bf206c8a2436374cca401f5b00d))
* **replay:** shutting down before example load ([937fd9b](https://github.com/ulixee/agent/commit/937fd9b3452053687c13760c643141b7eab6534a))
...
* **core:** don’t wait to scroll past bottom ([9f8877b](https://github.com/ulixee/agent/commit/9f8877b0b78924c8cf364b891ec2ed0ca6167d92))
...
* **docs:** secret agent.md url broken ([167fe5a](https://github.com/ulixee/agent/commit/167fe5a37b7f32257b59ddd38e5142728ffc768c))
...
* **replay:** fix stalling loads ([7ca1dbd](https://github.com/ulixee/agent/commit/7ca1dbd91e59d5c5d6812ba62bec517f746b2374))
* don’t use vertical screen orientations ([7121e94](https://github.com/ulixee/agent/commit/7121e940e331e8a15fa9b67dfc3b3d0322ddb161))
...
* emulators should not use accept-language values from json if using custom locale ([fc00660](https://github.com/ulixee/agent/commit/fc0066009a95bba60df2d7de6ed9a5435a807d4b))
* emulators were failing some double-agent tests ([5ae4f55](https://github.com/ulixee/agent/commit/5ae4f5507662ed91d19086d9dbab192e50a8f5c5))
...
* **emulator:** bug fix for Error.toString ([d23704a](https://github.com/ulixee/agent/commit/d23704a3731d2f5617d0493064c8c9593793b4df))
...
* **client:** split out IUnblocked AgentClass ([8765900](https://github.com/ulixee/agent/commit/876590001e62598daaad71d9a236e94600717c72))
...
* **client:** merge Browser/User into Unblocked Agent ([364ed8a](https://github.com/ulixee/agent/commit/364ed8ab9c16cdf40c8ad1f151de4b06efcc557d))
...
* **replay:** cross domain iframes ([db65711](https://github.com/ulixee/agent/commit/db6571120ccf1c5fa59c091bde6d752706c5c2e6))
* **replay:** loading resources ([747f4ff](https://github.com/ulixee/agent/commit/747f4ff24ba7ef1b162f0a2a5f1327ebd39cf18e))
...
* **session:** support CSSOM for recorder/playback ([0cbe7c8](https://github.com/ulixee/agent/commit/0cbe7c81aa6e6111a82db4bcbff5bf2efbc6d5b9))
* **session:** track frame dom node ids ([a41d678](https://github.com/ulixee/agent/commit/a41d6786d6fd10a386d9c2739713a26b6063b127))
* **session-state:** record and playback shadows ([508fd39](https://github.com/ulixee/agent/commit/508fd3988eb5e25d2c11a713a99f3f6a5a78ed5b))
...
* **client:** add scrollTo shortcut ([a1613f1](https://github.com/ulixee/agent/commit/a1613f15907c6eaea30e597bdabc3238eb7c96c1))
...
* **replay:** install script broke ([b79c572](https://github.com/ulixee/agent/commit/b79c572883a8c7b0240c97c13ca1d0cf9ef8cc43))
...
* **replay:** bug with monorepo replay versions ([05aa786](https://github.com/ulixee/agent/commit/05aa786527d0b65d7097cbba623633294c615627))
...
* publish latest replay ([62d1ef0](https://github.com/ulixee/agent/commit/62d1ef046bccb2d90df206d5425999a80b7d4fd8))
...
* extend tests for emulate test ([71764b7](https://github.com/ulixee/agent/commit/71764b7c52b46d47e3a0334c94a97429ad375703))
...
* **replay:** fix command overlays ([926dcba](https://github.com/ulixee/agent/commit/926dcba7e10635c3917ffa9dca72c6fb6fe29016))
...
* **replay:** resetting navigation needs to clear ([daf9431](https://github.com/ulixee/agent/commit/daf94318029f2d6ddf0ce88686f7748bc1d28f0c))
* **replay:** use shadow dom for replay elements ([b19b382](https://github.com/ulixee/agent/commit/b19b3820eb93fd7302e7fd416dde6e5aad988209))
...
* **replay:** playback on page 2 ([005bed8](https://github.com/ulixee/agent/commit/005bed89efd198b434e947d21390678eceef5eee))
...
* **docs:** Update documentation ([2295725](https://github.com/ulixee/agent/commit/2295725dceed7026bee9a4a291d551c75fe5279f)), closes [#56](https://github.com/ulixee/agent/issues/56)
...
* copy engine to deployed emulators ([98ea24c](https://github.com/ulixee/agent/commit/98ea24ca25d0cebbc1b6f6d572134e63318ce941))
...
* humanoid keys => ids ([a30652e](https://github.com/ulixee/agent/commit/a30652e5e664955e2f337799a986447e18f25f3a))
* **emulators:** wait for doc element ([c67fbf8](https://github.com/ulixee/agent/commit/c67fbf8cc089881a2bf4a5def83dcac67630e4f2))
...
* **replay:** fix realtime not loading correctly ([29ff447](https://github.com/ulixee/agent/commit/29ff4471073a15505d27d5453cb1c13daf824f83))
* **replay:** fix rendering doctype + svg ([ac36c79](https://github.com/ulixee/agent/commit/ac36c791c9d3611874900c65e8180b7daa1ed232))
* vue structure for replay ([0e38bfa](https://github.com/ulixee/agent/commit/0e38bfa5f16c63a7900136e2300214bda395a5cf))
...
* **emulators:** add windows runtime polyfills ([51ebb11](https://github.com/ulixee/agent/commit/51ebb1107ff42f19a453a268c243b19c2d0f2644))
...
* restructure frontend to match vue project ([f3348a0](https://github.com/ulixee/agent/commit/f3348a01650e2747a26fa0b2ab9bd4c082300f37))
...
* **emulator-plugins:** include origin for cors ([b1449c1](https://github.com/ulixee/agent/commit/b1449c1233dc692ccfc68d3b81070e5ff7b9fcba))
* **replay:** handle frames and page source changes ([fc703d5](https://github.com/ulixee/agent/commit/fc703d5181eb961307b44553aa02a62f4faf98c0))
* circleci configs ([7d8e213](https://github.com/ulixee/agent/commit/7d8e213032baa58a14d9f9eb6f161b4b2996b5c0))
* pool socket connections per origin ([0075f18](https://github.com/ulixee/agent/commit/0075f18a64a2761f0979c072e42958002664b2df))
* **ci:** circle ci fixes ([24596b5](https://github.com/ulixee/agent/commit/24596b5b8903d4857e60aac964a1c7f5e43731c6))
...
* **replay:** fix picker ([50d7885](https://github.com/ulixee/agent/commit/50d7885f836067d51dc1ef50b41376cd9e3b9508))
...
* lerna packages ([92798e8](https://github.com/ulixee/agent/commit/92798e8c9a017754ec86edf3dfe09de90828cb00))
* packaging issues with mitm and replay ([520a912](https://github.com/ulixee/agent/commit/520a912d50b935270b75f2d6ef1faf5fed796e85))
...
* **replay:** fix replay api usage ([c54fe64](https://github.com/ulixee/agent/commit/c54fe64b710519088cda4638c7ad2b16a5313e13))
...
* publish README.md with next build ([4c8b942](https://github.com/ulixee/agent/commit/4c8b9428616c743a1282ad2f67a42ed74a3ebd60))


### Features

* **replay:** add mouse/focus/scroll events ([efec55c](https://github.com/ulixee/agent/commit/efec55cf093bd4207164abd304a64f73620c45a9))
...
* **replay:** autoplay replay ([bd13ef5](https://github.com/ulixee/agent/commit/bd13ef56728d4582a3e4827e21f1688e6269fbb2))
...
* .gitignore was ignoring files that were needed for website ([4b9a2e4](https://github.com/ulixee/agent/commit/4b9a2e4d12c88a44a78c39c0872556990cb1bb74))
...
* **emulators:** Emulator plugins - set agent ([e53cedb](https://github.com/ulixee/agent/commit/e53cedbfca077239d36116f22d5be2d1ab9ec7a3)), closes [#8](https://github.com/ulixee/agent/issues/8)
...
* Emulator plugin referencing relative paths ([f26feab](https://github.com/ulixee/agent/commit/f26feab5899fa11e73ad55d6239912b798aa0e79))

...
export default class Plugins implements IUnblockedPlugins {
    ...
    shouldInterceptRequest(url: URL, resourceTypeIfKnown?: IResourceType): Promise<boolean>;
    handleInterceptedRequest(url: URL, type: IResourceType, request: IncomingMessage | Http2ServerRequest, response: ServerResponse | Http2ServerResponse): Promise<boolean>;

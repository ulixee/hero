...
test('should be able to override a function', async () => {
    ...
    (0, _proxyUtils_1.replaceFunction)(win.TestClass.prototype, 'doSomeWork', (target, thisArg, args) => {
...
test('should be able to combine multiple single instance overrides', async () => {
    ...
    (0, _proxyUtils_1.replaceFunction)(TestClass.prototype, 'doSomeWork', () => 'base');
    (0, _proxyUtils_1.replaceFunction)(a, 'doSomeWork', t => 'a', { onlyForInstance: true });
    (0, _proxyUtils_1.replaceFunction)(b, 'doSomeWork', () => 'b', { onlyForInstance: true });
